...
class LoadImageCommentsFromRemoteUseCaseTests: XCTestCase {
    ...
    func test_load_deliversErrorOnAny2xxHttpResponseWithInvalidJSON() {
        let (sut, client) = makeSUT()
    ...
    func test_load_deliversNoItemsOnAny2xxHttpResponseWithEmptyList() {
        let (sut, client) = makeSUT()
    ...
    func test_load_deliversItemsOnAny2xxHttpResponseWithJSONItems() {
        let (sut, client) = makeSUT()
