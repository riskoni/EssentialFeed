...
final class CommentsUIIntergationTests: XCTestCase {
    ...
    func test_loadCommentsCompletion_rendersSucessfullyLoadedComments() {
    ...
    func test_loadCommentCompletion_doesNotAlterCurrentRenderintStateOnError() {
