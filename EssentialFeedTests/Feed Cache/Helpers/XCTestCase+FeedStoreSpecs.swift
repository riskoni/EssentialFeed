...
extension FeedStoreSpecs where Self: XCTestCase {
    ...
    func expect(_ sut: FeedStore, toRetrieveTwice expectedReuslt: FeedStore.RetrievalResult, file: StaticString = #file, line: UInt = #line){
        expect(sut, toRetrieve: expectedReuslt, file: file, line: line)
        expect(sut, toRetrieve: expectedReuslt, file: file, line: line)
    }
    
    func expect(_ sut: FeedStore, toRetrieve expectedReuslt: FeedStore.RetrievalResult, file: StaticString = #file, line: UInt = #line){
        ...
        sut.retrieve{ retrievalResult in
            ...
            case let (.success(.found(feed: retrievedFeed, timestamp: retrievedTimestamp)),
            ...
            default:
                XCTFail("Expected to retrieve \(expectedReuslt), got \(retrievalResult) instead", file: file, line: line)
            }
