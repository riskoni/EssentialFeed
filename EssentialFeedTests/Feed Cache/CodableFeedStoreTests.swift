...
class CodableFeedStoreTests: XCTestCase {
    ...
    private func expect(_ sut: FeedStore, toRetrieveTwice expectedReuslt: RetrieveCachedFeedResult, file: StaticString = #file, line: UInt = #line){
        expect(sut, toRetrieve: expectedReuslt, file: file, line: line)
        expect(sut, toRetrieve: expectedReuslt, file: file, line: line)
    }
    
    private func expect(_ sut: FeedStore, toRetrieve expectedReuslt: RetrieveCachedFeedResult, file: StaticString = #file, line: UInt = #line){
